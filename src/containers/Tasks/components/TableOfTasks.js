...
export const TableOfTasks = () => {
  ...
  const customWidth = isEditFormVisible || isCreateFormVisible ? 'calc(100% - 980px)' : 'none'

  return (
    <section className={styles.tableSection} style={{maxWidth: customWidth}}>
      <table className={styles.tableHead}>
        <thead>
          <tr>
            <th className={styles.withBorder}>ID</th>
            <th className={styles.withBorder}>Название</th>
            <th className={styles.withBorder}>Статус</th>
            <th>Исполнитель</th>
